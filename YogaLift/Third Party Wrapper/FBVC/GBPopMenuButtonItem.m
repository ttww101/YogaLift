...
#pragma mark - 展开方法
/**
 *  展开item,以kMenuItemShowTypeRadRight、kMenuItemShowTypeRadLeft以及kMenuItemShowTypeLine方式打开的item，其中kMenuItemShowTypeLine会调用itemShowWithTargetPoint方法
 *
 *  @param angle 角度
 */
...
/**
 *  展开item,以kMenuItemShowTypeLine方式打开的item
 *
...
/**
 *  展开item，以kMenuItemShowTypeLine和kMenuItemShowTypeRound方式打开的item
 *
 *  @param angle 展开角度
 */
...
/**
 *  展开方式为kMenuItemShowTypeRound时根据角度计算目标点
 *
 *  @param angle 需要平移的角度
 *
...
/**
 *  隐藏item,以kMenuItemShowTypeLine和kMenuItemShowTypeRound方式打开的item
 *
...
/**
 *  隐藏item，以kMenuItemShowTypeRadLeft和kMenuItemShowTypeRadRight方式打开的Item
 */
